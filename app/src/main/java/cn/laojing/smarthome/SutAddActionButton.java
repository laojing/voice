...
public class SutAddActionButton extends SutActionButton {
    int mPlusColor;

    public SutAddActionButton(Context context) {
        this(context, null);
    }

    public SutAddActionButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SutAddActionButton(Context context, AttributeSet attrs, int defStyle) {

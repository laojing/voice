...
public class SutCircleButton extends ImageView {
    ...
    public SutCircleButton(Context context) {
        super(context);
        init(context, null);
    }

    public SutCircleButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SutCircleButton(Context context, AttributeSet attrs, int defStyle) {

...
public class SutActionButton extends ImageButton {
    ...
    public SutActionButton(Context context) {
        this(context, null);
    }

    public SutActionButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SutActionButton(Context context, AttributeSet attrs, int defStyle) {

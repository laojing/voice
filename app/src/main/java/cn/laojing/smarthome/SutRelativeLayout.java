...
public class SutRelativeLayout extends RelativeLayout {
    private int screenWidth;
    private float fractionX;
    private OnLayoutTranslateListener onLayoutTranslateListener;

    public SutRelativeLayout(Context context) {
        super(context);
    }

    public SutRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SutRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static interface OnLayoutTranslateListener {
        void onLayoutTranslate(SutRelativeLayout view, float xFraction);
    }
}